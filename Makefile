...
Makefile.conf: 
	C:\Coq\bin\coq_makefile.exe -R . OUVerT axioms.v bigops.v chernoff.v compile.v dist.v dyadic.v expfacts.v extrema.v learning.v listlemmas.v maplemmas.v numerics.v orderedtypes.v strings.v vector.v -o Makefile
