...
Makefile.conf: 
	coq_makefile -R . OUVerT -arg '-w notation-overriden' bigops.v compile.v dist.v learning.v dyadic.v extrema.v listlemmas.v maplemmas.v numerics.v orderedtypes.v strings.v vector.v expfacts.v -o Makefile
