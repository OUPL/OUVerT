...
Makefile.conf: 
	coq_makefile -R . OUVerT -arg '-w none' bigops.v compile.v dist.v dyadic.v extrema.v listlemmas.v maplemmas.v numerics.v orderedtypes.v strings.v vector.v expfacts.v axioms.v chernoff.v -o Makefile
